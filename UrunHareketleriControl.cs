...
{
    public partial class UrunHareketleriControl : UserControl
    {
        private DataTable _hareketTablosu;

        public UrunHareketleriControl()
        {
            InitializeComponent();
            TabloKur();
            OrnekVerileriYukle();
            ...
            if (dataGridView.Columns.Count >= 6)
            {
                ...
                dataGridView.Columns[2].Width = 150;  // Ürün Adı
        ...
        private void TabloKur()
        {
            ...
            _hareketTablosu.Columns.Add("Ürün Adı", typeof(string));
        ...
        {
            Tools.ExportHelper.ExportToPdfOrHtml(dataGridView, "Ürün Hareketleri Raporu");
        }

        private void btnExcelAktar_Click(object sender, EventArgs e)
        {
            Tools.ExportHelper.ExportToExcel(dataGridView, "UrunHareketleri");
        }
