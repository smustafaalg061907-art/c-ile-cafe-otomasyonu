...
{
    public partial class MenuHareketleriControl : UserControl
    {
        private DataTable _hareketTablosu;

        public MenuHareketleriControl()
        {
            InitializeComponent();
            TabloKur();
            OrnekVerileriYukle();
            ...
            if (dataGridView.Columns.Count >= 6)
            {
                ...
                dataGridView.Columns[2].Width = 150;  // Menü/Kategori Adı
                dataGridView.Columns[3].Width = 150;  // İşlem Türü
                dataGridView.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill; // Açıklama
                dataGridView.Columns[5].Width = 130;  // Kullanıcı
            }
        }
        ...
        private void TabloKur()
        {
            ...
            _hareketTablosu.Columns.Add("Menü/Kategori Adı", typeof(string));
        ...
        {
            Tools.ExportHelper.ExportToPdfOrHtml(dataGridView, "Menü Hareketleri Raporu");
        }

        private void btnExcelAktar_Click(object sender, EventArgs e)
        {
            Tools.ExportHelper.ExportToExcel(dataGridView, "MenuHareketleri");
        }
