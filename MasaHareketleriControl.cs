...
{
    public partial class MasaHareketleriControl : UserControl
    {
        private DataTable _hareketTablosu;

        public MasaHareketleriControl()
        {
            InitializeComponent();
            TabloKur();
            OrnekVerileriYukle();
            ...
            if (dataGridView.Columns.Count >= 6)
            {
                ...
                dataGridView.Columns[2].Width = 120;  // Masa Adı
        ...
        private void TabloKur()
        {
            ...
            _hareketTablosu.Columns.Add("Masa Adı", typeof(string));
        ...
        {
            Tools.ExportHelper.ExportToPdfOrHtml(dataGridView, "Masa Hareketleri Raporu");
        }

        private void btnExcelAktar_Click(object sender, EventArgs e)
        {
            Tools.ExportHelper.ExportToExcel(dataGridView, "MasaHareketleri");
        }
